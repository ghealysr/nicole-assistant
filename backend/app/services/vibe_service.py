...
class VibeService:
    ...
    # Model configuration - Latest Claude 4.5 models (December 2025)
    SONNET_MODEL = "claude-sonnet-4-5-20250929"  # Claude 4.5 Sonnet
    OPUS_MODEL = "claude-opus-4-5-20251101"       # Claude 4.5 Opus
