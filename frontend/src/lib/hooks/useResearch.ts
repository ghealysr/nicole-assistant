...
// Full research response - matches backend get_research() output
export interface ResearchResponse {
  ...
  // These are the primary fields used for rendering beautiful articles
  article_title: string;     // Journalist-crafted headline
  subtitle: string;          // Brief subheading capturing key insight
  lead_paragraph: string;    // Opening hook paragraph
  body: string;              // Full article prose (2-4 paragraphs)
  bottom_line: string;       // Powerful concluding sentence
  
  // Legacy/fallback fields (for backwards compatibility)
  executive_summary: string; // Gemini's raw summary
  nicole_synthesis: string;  // Original synthesis field
